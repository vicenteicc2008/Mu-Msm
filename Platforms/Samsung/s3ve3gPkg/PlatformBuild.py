# @file
# Script to Build Samsung Galaxy S3 Neo Duos UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("s3ve3gPkg",)
    ArchSupported = ("ARM",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('s3ve3g', 'gcc_arm_linux', 'edk2-build')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("s3ve3gPkg/s3ve3gPkg.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "s3ve3gPkg/s3ve3gPkg.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "s3ve3g", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "s3ve3gPkg/s3ve3gPkg.dsc", "Platform Hardcoded")
